 ...
 */
public class ConnectionKerberos extends Connection {
    ...
    protected void authenticate() {
        ...
        bindingProvider.getRequestContext().put(Credentials.class.getName(), creds);
        bindingProvider.getRequestContext().put("http.autoredirect", true);
        bindingProvider.getRequestContext().put(AuthSchemeProvider.class.getName(), authSchemeRegistry);
    }
